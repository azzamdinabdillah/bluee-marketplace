...
import messageIcon from "/icons/message-text.svg";
  ...
  return (
    ...
    >
      <div className="grid w-full grid-cols-1 gap-4 md:grid-cols-2 md:gap-5 lg:grid-cols-2 xl:grid-cols-[40fr_30fr_30fr]">
        ...
        />
        <StatCard iconSrc={Profile2User} value="3.200" label="Total Buyers" />
      </div>

      <div className="grid items-start gap-3 md:gap-5 lg:grid-cols-2">
        <StatCard iconSrc={receiptIcon} value="3.200" label="Total Transaction">
          ...
          <div className="flex flex-col gap-4">
            {transactions.map((transaction) => (
              <div
                key={transaction.id}
                className="border-stroke-color flex flex-col gap-4 rounded-2xl border p-4 md:gap-5 md:rounded-[20px] md:px-5 md:py-[18px]"
              >
                <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
                  <div className="flex items-center gap-2.5 md:gap-3 lg:gap-4">
                    ...
                    <div className="flex flex-col gap-1 md:gap-1.5">
                      <h4 className="text-black-color text-base font-bold md:text-[17px] lg:text-lg">
                        {transaction.name}
                      </h4>
                      <div className="flex items-center gap-1 md:gap-1.5">
                        ...
                        />
                        <span className="text-sec-color text-sm font-semibold md:text-[15px] lg:text-base">
                          {transaction.phone}
                        </span>
                      </div>
                    </div>
                ...
                <div className="flex items-center justify-between gap-5">
                  <div className="flex items-center gap-2.5 md:gap-3 lg:gap-4">
                    ...
                    <div className="flex flex-col gap-0.5 md:gap-1">
                      <span className="text-black-color text-base font-bold md:text-[17px] lg:text-lg">
        ...
        <StatCard iconSrc={messageIcon} value="1.000" label="Total Reviews">
          <h3 className="text-black-color text-base font-bold md:text-xl">
            Latest Reviews
          </h3>
              ...
              >
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-2">
                    <blockquote className="text-sec-color text-sm leading-relaxed font-medium md:text-[15px] lg:text-base">
                      "{review.content}"
                    </blockquote>
