...
export default function ProductTestimony({ testimonials }: ProductTestimonyProps) {
    return (
        <div className="flex flex-col gap-6 w-full">
            <h3 className="text-[18px] font-bold leading-[1.25em] text-black">Product Testimony</h3>
